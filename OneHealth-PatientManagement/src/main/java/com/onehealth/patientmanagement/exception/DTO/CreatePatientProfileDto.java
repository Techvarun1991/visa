...
public class CreatePatientProfileDto {
	 ...
	 private Long userId;
		...
		public CreatePatientProfileDto(String patientId, Long userId, String firstName, String lastName,
				String mobileNumber, String address, int pinCode, String country, String city, String gender, int age,
				Date dob, String bloodGroup, float height, float weight, String maritalStatus, String image,
		...
		public String toString() {
			return "CreatePatientProfileDto [patientId=" + patientId + ", userId=" + userId + ", firstName=" + firstName
